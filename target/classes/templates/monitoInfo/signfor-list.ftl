...
<script type="text/javascript"> 
    function dialog_editCourierSignFor() {
	    $(".bjui-pageContent").dialog({
	        type:'POST',
	        id:'addCourier_dialog',
	        url:'/setting/storage/getStorageCouriersByUserIdSignFor',
	        data:{"shipperCode":$("#shipperCodeSignFor").val()},
	        mask:true,
	        title:'选择仓库快递',
	        height:400,
	        width:800,
...
<div class="bjui-pageHeader" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${request.contextPath}/monitoInfo/yuantong/signFor"
          method="post">
        ...
        <div class="bjui-searchBar">
            ...
            <@shiro.hasPermission name="/monitoInfo/exportExcelSet">
                <button  data-url="${request.contextPath}/monitoInfo/exportExcelSet?type=yuantongSignForInfoWhere&&belongTo=yt-3-4"
        ...
        <div class="bjui-moreSearch">
            ...
            <textarea name="courierName" id="courierNameSignFor" cols="75" rows="4" readonly="true">${infoWhere.courierName}</textarea>
            <input type="hidden" name="shipperCode" id="shipperCodeSignFor" value="${infoWhere.shipperCode}">
            <a class="btn btn-green"    onclick="dialog_editCourierSignFor()"  >选择仓库快递</a> 
            <br><br>
