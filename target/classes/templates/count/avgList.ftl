<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" class="pageForm" action="${request.contextPath}/count/avgList"
                ...
                <table class="table table-condensed table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            &nbsp;
                        <@shiro.hasPermission name="/count/startAvgDay">
                            <button data-url="${request.contextPath}/count/avg_select"
                                    class="btn-green" data-icon="save" data-title="统计条件选择"
                                    data-toggle="dialog"
                                    data-width="600" data-height="400" data-id="dialog">统计平均天数
                            </button>
                        </@shiro.hasPermission>
                        </td>
                    </tr>
        ...
        <table class="table table-bordered table-hover table-striped table-top">
            ...
            <#if lists??>
                ...
                <tr data-id="1">
                    ...
                    <td><#if fileup.belongTo == "3-0">平均天数统计</#if></td>
