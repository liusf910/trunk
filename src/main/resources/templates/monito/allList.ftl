<#escape x as x?html>
 <script type="text/javascript">
      ...
      function getShipperCode(){
      	$('#shipperCodeAll').val($('#shipperCodeSelectAll').val());
      }
    </script>
<div class="bjui-pageHeader" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${request.contextPath}/monito/all/list"
          method="post">
        ...
        <div class="bjui-searchBar"> 
            ...
            <button  data-url="${request.contextPath}/monito/exportExcelSet?type=all&&belongTo=3-1"
        ...
        <div class="bjui-moreSearch">
            ...
            <input type="hidden" name="storageCode" id="storageCodeAll" value="${infoWhere.storageCode}">
            <label>快递公司：</label>&nbsp;&nbsp;
            ...
            <input type="checkbox"  <#if infoWhere.rgxtFlag=true >checked="checked"</#if>id="j_table_chk_5" name="rgxtFlag"
                   value="true" data-toggle="icheck" data-label="人工导入早于系统对接24h">&nbsp;
            <input type="checkbox"  <#if infoWhere.fhTookFlag=true >checked="checked"</#if>id="j_table_chk_6" name="fhTookFlag"
                   value="true" data-toggle="icheck" data-label="20点后发货当天揽收">&nbsp;
