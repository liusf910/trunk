...
<div class="bjui-pageContent">
    <div style="margin:15px auto;">
        <form id="add_role_form" action="${request.contextPath}/setting/role/add" class="pageForm" method="post"
            ...
            <table class="table table-condensed table-hover">
                <tr>
                    ...
                    <td>
                        <input type="text" name="roleName" data-rule="required" size="20"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <#if permissionAll??>
                            <#list permissionAll as pmi>
                                <li data-id="${pmi.mid}" data-pid="${pmi.pid}">${pmi.name}</li>
                            </#list>
                        </#if>
                        </ul>
                    </td>
