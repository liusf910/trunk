<@shiro.hasPermission name="/setting/timelimit/down"><#assign fileupDownMark = true/></@shiro.hasPermission>
<@shiro.hasPermission name="/setting/timelimit/delete"><#assign fileupDelMark = true/></@shiro.hasPermission>
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" class="pageForm"
          action="${request.contextPath}/setting/timelimit/list"
        ...
        <table class="table table-bordered table-hover table-striped table-top">
            ...
            <#if lists??>
                ...
                <tr data-id="1">
                    ...
                    <td><#if fileup.belongTo == "1-0">时效</#if></td>
                    ...
                    <td>
                        ...
                        <#if fileupDelMark>
                            <a href="${request.contextPath}/setting/timelimit/delete?fileId=${fileup.fileId?string('#')}"
...
<div class="bjui-pageFooter">
    <ul>
    <@shiro.hasPermission name="/upload/timelimit">
        <li>
            <button href="${request.contextPath}/setting/timelimit/time_upload" type="submit" class="btn-red"
                    data-icon="save"
                    data-toggle="dialog"
                    data-width="500" data-height="300" data-id="dialog">时效上传
            </button>
        </li>
    </@shiro.hasPermission>
    </ul>
